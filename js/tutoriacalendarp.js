window.addEventListener("load", function () {
  ...
  console.log('Script tutoriacalendarst.js cargado y ejecutado');
// Código del script...

  // Obtener los datos de las tutorías
  const tutorias = [
    { dia: 'Lunes', hora: '10:00', duracion: 2 , fase: 1 , salon: 'Sala de profesores tiempo completo' , estudiante: 'Estudiante Uleam 1' , proyecto:'tesis 1'},
    { dia: 'Viernes', hora: '12:00', duracion: 1 , fase: 1 ,salon: 'Sala de profesores tiempo completo'  , estudiante: 'Estudiante Uleam 2', proyecto:'tesis 2' },
    { dia: 'Martes', hora: '16:00', duracion: 2 , fase: 2 , salon: 'Sala de profesores tiempo completo' , estudiante: 'Estudiante Uleam 3' , proyecto:'tesis 3'},
    { dia: 'Miércoles', hora: '17:00', duracion: 1 , fase: 1 ,salon: 'Sala de profesores tiempo completo'  , estudiante: 'Estudiante Uleam 4', proyecto:'tesis 4'},
    { dia: 'Jueves', hora: '12:00', duracion: 2 , fase: 2 , salon: 'Sala de profesores tiempo completo' , estudiante: 'Estudiante Uleam 5', proyecto:'tesis 5' },
    { dia: 'Viernes', hora: '8:00', duracion: 1 , fase: 2 ,salon: 'Sala de profesores tiempo completo'  , estudiante: 'Estudiante Uleam 6' , proyecto:'tesis 6'},
          ...
          box.addEventListener('click', () => {
            ...
            detalles.innerHTML = `
              ...
              <div style="font-size:30px; padding-top:20px;" class="datostutoria">
                ...
                <p><strong>Fase: </strong> ${tutoria.fase === 1 ? 'Fase Diseño' : 'Fase Resultados'} </p>
                <p><strong>Proyecto: </strong>${tutoria.proyecto} </p>
                <p><strong>Tutor: </strong> ${tutoria.estudiante} </p>
              </div>
            ...
            confirmar.addEventListener('click', () => {
              if (confirm('¿Estás seguro de confirmar la realización de la tutoría?')) {
                if (confirm('Se cumplieron los requirimientos pendientes en esta tutoría?')) {
